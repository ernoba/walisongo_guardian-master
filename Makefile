...
CXXFLAGS = -O3 -static -I. -DUNICODE -D_UNICODE

# Library Windows yang harus di-link secara manual
LIBS = -lwininet -lwinhttp -lws2_32 -lwlanapi -lgdi32 -lgdiplus -ladvapi32 -lshell32 -lrpcrt4 -lole32 -loleaut32 -luuid -ltaskschd
